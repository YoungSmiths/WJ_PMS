...
import com.wj.pms.mybatis.entity.OrderState;
...
public interface OrderStateMapper {
    ...
    @Insert({
        "insert into order_state (id, code, ",
        "state_name, state, ",
        "create_by, create_time, ",
        "update_by, update_time)",
        "values (#{id,jdbcType=VARCHAR}, #{code,jdbcType=VARCHAR}, ",
        "#{stateName,jdbcType=VARCHAR}, #{state,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, code, state_name, state, create_by, create_time, update_by, update_time",
        "from order_state",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
    ...
    OrderState selectByPrimaryKey(String id);

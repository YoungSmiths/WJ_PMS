...
public interface RoleInfoMapper {
    ...
    @Insert({
        ...
        "role_code, state, create_by, ",
        "create_time, update_by, ",
        "update_time)",
        "values (#{id,jdbcType=DECIMAL}, #{roleName,jdbcType=VARCHAR}, ",
        "#{roleCode,jdbcType=VARCHAR}, #{state,jdbcType=BIT}, #{createBy,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, role_name, role_code, state, create_by, create_time, update_by, update_time",
        "from role_info",
        "where id = #{id,jdbcType=DECIMAL}"
    })
    @Results({
    ...
    RoleInfo selectByPrimaryKey(BigDecimal id);
